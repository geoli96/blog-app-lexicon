...
export default function BackLink({ fallback = "/", children = "← Back", navigatedTo = true }: { fallback?: string; children?: ReactNode; navigatedTo?:boolean }) {
  ...
  if(!navigatedTo) return <div className={styles.emptyLink} ></div>;
